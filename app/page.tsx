...
const features = [
  {
    ...
    description: "Keep all yoyur important PDF files securely stored and easily accessible anytime, anywhere",
    icon: GlobeIcon
  },
  {
    name: "Blazing Fast Responses",
    description: "Experience lightning-fast answers to your queries, ensurong you get the information you need instantly.",
    icon: ZapIcon
  },
  {
...
export default function Home() {
  return <main className="flex-1 bg-gradient-to-br p-2 lg:p-5 from-white to-indigo-600 overflow-scroll [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
      ...
      <div className="flex flex-col justify-center items-center mx-auto  max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            ...
            <br />
            <br /> Upload your document, and our chatbot will answer questions, summarize content, and answer all your Qs. Ideal for everyone, <span className="text-indigo-600">Chat with PDF</span>{" "} turns static documents into{" "}
            <span className="font-bold">dynamic converstions</span> enhancing productivity 10x fold effortlessly.
          </p>
        </div>
      ...
      <div className="relative overflow-hidden pt-16">
        <div className="mx-auto max-w-7xl px-6 lg:px-20">
          <Image
            ...
            width={2432}
            height={1442}
            className="mb-[-0%] rounded-xl ring-1 ring-gray-900/10"
          />
          ...
          {features.map((feature) => (
            <div className="relative pl-9" key={feature.name}>
              ...
              <div className="flex flex-col gap-1">
                <dd className="font-bold text-xl">{feature.name}</dd>
