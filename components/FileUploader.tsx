...
export default function FileUploader() {
    ...
    return (
        <div className='flex flex-col gap-4 items-center mx-auto w-full'>
            {/* Loading... tomorrow */}
            {uploadInProgress && (
            ...
            {!uploadInProgress && (
                <div {...getRootProps()}
                    className={`p-10 border-2 border-dashed mt-10 w-[80%] border-indigo-600 text-indigo-600 rounded-lg h-96 flex items-center justify-center ${isFocused || isDragAccept ? "bg-indigo-300" : "bg-indigo-100"}`}
                >
                    <input {...getInputProps()} />
