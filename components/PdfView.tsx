...
import { Loader2Icon, RotateCw, VoteIcon, ZoomInIcon, ZoomOutIcon } from "lucide-react";

// We need to configure CORS
// gsutil cors set cors.json gs://<app-name>.appspot.com
// gsutil cors set cors.json gs://chat-with-pdf-37e41.appspot.com
// go here >>> https://console.cloud.google.com/
// Create new file in editor calls cors.json
// run >>> // gsutil cors set cors.json gs://chat-with-pdf-37e41.appspot.com
